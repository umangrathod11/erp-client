...
const CreateInvoice = () => {
      ...
      try {
         ...
         if (response.data && response.data.data.length > 0) {
            ...
            setInvoiceData((prevData) => ({
               ...
               invoice_id: allData._id,
               invoice_number: allData.invoice_number,
               date: allData.date,
               fullName: allData.fullName,
               email: allData.email,
               phoneNumber: allData.phoneNumber,
               invoiceAddress: allData.invoiceAddress,
               productName: allData.productName,
               paymentMethod: allData.paymentMethod,
               totalPayment: allData.totalPayment,
               paidPayment: allData.paidPayment,
               invoiceNotes: allData.invoiceNotes,
               dueAmount: allData.dueAmount,
               dueAmountDate: new Date(allData.dueAmountDate).toLocaleDateString("en-CA"),
               membershipMonth: allData.membershipMonth
            }));
   ...
   const handleSubmit = async (e) => {
      ...
      try {
         const response = await axiosInstance.post(`/invoice/update?id=${invoiceData.invoice_id}`, invoiceData);
                              ...
                              <div className="new-user-info">
                                 <form onSubmit={handleSubmit}>
                                    <div className="row mb-3">
                                       ...
                                       <div className="col-md-6 mb-2">
                                          <div className="form-outline">
                                             <label className="form-label" htmlFor="totalPayment">Total Amount :</label>
                                             <input
                                                type="number"
                                                required
                                       ...
                                       <div className="col-md-6 mb-2">
                                          <div className="form-outline">
                                             <label className="form-label" htmlFor="paidPayment">Paid Amount :</label>
                                             <input
                                                type="number"
                                                required
